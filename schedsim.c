...
{ 
  /*
     ...
     4. Keep traversing the all processes while all processes are not done. Do following for 
     ...
     */
      ...
      while (process_counter < n){
        ...
        if (rem_bt[min_index] ==0){
          ...
          plist[min_index].wt = completion_time - plist[min_index].bt;
